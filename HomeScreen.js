...
const CALCULATORS = [
  {
    id: 'DPS',
    title: 'DPS',
    subtitle: 'Monthly Deposit Scheme',
    icon: 'calendar-outline',
    gradColors: ['#1E40AF', '#3B82F6'],
    glowColor: '#3B82F6',
    screen: 'DPSCalculator',
  },
  {
    id: 'FDR',
    title: 'FDR',
  ...
  },
  {
    id: 'AMORT',
    title: 'Amortization',
    subtitle: 'Loan Schedule',
    icon: 'bar-chart-outline',
    gradColors: ['#92400E', '#F59E0B'],
    glowColor: '#F59E0B',
    screen: 'AmortizationCalculator',
  },
  {
    id: 'GOAL',
    title: 'Goal Planner',
...
const CalculatorCard = ({ item, onPress }) => (
  <TouchableOpacity
    ...
    <LinearGradient
      ...
      {/* Glow circle */}
      <View style={[styles.glowCircle, { backgroundColor: item.glowColor + '33' }]} />
    ...
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <LinearGradient
          ...
          {/* Hero banner */}
          <LinearGradient
            colors={['#1E3A5F', '#0E1F35']}
            style={styles.heroBanner}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 1 }}>
            <Text style={styles.heroTitle}>Plan Smarter.{'\n'}Grow Faster. 🚀</Text>
            <Text style={styles.heroSub}>
              Calculate DPS, FDR, EMI, loan schedules and your savings goals — all in one place.
            </Text>
          </LinearGradient>
        </LinearGradient>
        ...
        <View style={styles.sectionHeader}>
          ...
          <Text style={styles.sectionCount}>{CALCULATORS.length - 1} tools</Text>
        </View>
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipText}>
            💡 <Text style={{ color: colors.gold, fontWeight: '700' }}>Pro Tip:</Text> Use the Goal
            Planner to calculate how much to save monthly for a dream purchase!
          </Text>
        </View>
      </ScrollView>
